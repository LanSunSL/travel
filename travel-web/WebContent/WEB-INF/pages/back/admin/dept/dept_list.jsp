								...
								<c:forEach items="${allDepts}" var="entry">
									<tr>
										<td class="text-center"><input type="text"
											id="dname-${entry.key.did}" class="form-control"
											value="${entry.key.dname}"></td>
										<td class="text-center"><span id="eid-${entry.key.eid}"
											style="cursor: pointer;">${entry.value.ename}</span></td>
										<td class="text-center">
											<button id="edit-${entry.key.did}" class="btn btn-warning">
